...
public class Task {
    ...
    public Task(Integer id, Employee employee, Project project, Status status, String name, String description,
            LocalDate startDate, LocalDate endDate, Time estimatedDuration, Integer progress, Time timePassed,
            Boolean isAssign, String comment) {
        this.setId(id);
