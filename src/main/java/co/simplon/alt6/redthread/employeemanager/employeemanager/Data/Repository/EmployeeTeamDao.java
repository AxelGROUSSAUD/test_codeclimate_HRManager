...
public class EmployeeTeamDao extends AbstractDao<EmployeeTeam> implements EmployeeTeamDaoI{
    ...
    public EmployeeTeamDao() {
        super("INSERT INTO employeeTeam (idEmployee, idTeam) VALUES (?, ?)"
    ...
    @Override
    protected void entityBindValuesWithId(PreparedStatement stmt, EmployeeTeam entity) throws SQLException {
