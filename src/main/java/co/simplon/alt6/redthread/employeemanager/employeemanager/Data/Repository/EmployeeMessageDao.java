...
public class EmployeeMessageDao extends AbstractDao<EmployeeMessage>
    implements EmployeeMessageDaoI {
  ...
  public EmployeeMessageDao() {
    super(
        "INSERT INTO employeeMessage (idEmployee, idMessage) VALUES (?, ?)",
  ...
  @Override
  protected void entityBindValues(PreparedStatement stmt, EmployeeMessage entity)
      throws SQLException {
  ...
  @Override
  protected void entityBindValuesWithId(PreparedStatement stmt, EmployeeMessage entity)
      throws SQLException {
