...
public class TaskHoursDao extends AbstractDao<TaskHours> implements TaskHoursDaoI{
    ...
    public TaskHoursDao() {
        super("INSERT INTO taskHours (idTask, idHours, timePassedToday) VALUES (?, ?, ?)"
    ...
    @Override
    protected void entityBindValuesWithId(PreparedStatement stmt, TaskHours entity) throws SQLException {
